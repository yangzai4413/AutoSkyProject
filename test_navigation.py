...
# 读取一张实际的图片（假设frame_0000.jpg为当前游戏画面）
current_screen = cv2.imread("dataset/isle_dawn/frame_0000.jpg")
...
# 读取另一张图片进行测试
current_screen2 = cv2.imread("dataset/isle_dawn/frame_0006.jpg")
